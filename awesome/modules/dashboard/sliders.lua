	...
	{
		{
			...
			markup = markup.fontfg(beautiful.font_name .. " 12", beautiful.accent_alt_color_dark, markup.bold("vol ")),
		},
		{
			id = "volume_bar",
			max_value = 100,
...
local mic_widget = wibox.widget({
	{
		{
			widget = wibox.widget.textbox,
			markup = markup.fontfg(beautiful.font_name .. " 12", beautiful.accent_color_dark, markup.bold("mic ")),
		},
		{
			id = "mic_bar",
			max_value = 100,
