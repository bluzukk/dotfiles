...
window_switcher_hide = function()
    ...
    if client.focus then
        ...
        -- window_switcher_last_client.border_color = beautiful.bg_color
    ...
    beautiful.border_color_active = beautiful.bg_color
end
...
return {
    window_switcher_show = window_switcher_show
}
