...
globalkeys = gears.table.join(
    ...
    -- User programs
    awful.key({ modkey }, "t", function () awful.spawn(browser)
                                        end,
    ...
    awful.key({ modkey }, "F4", function () panel.toggle_zenmode() end,
              {description = "run a game", group = "launcher"}),
    -- Prompt
    awful.key({ modkey }, "r",     function () uwuprompt.launch() end,
    ...
    awful.key({ modkey   }, "Escape", function () awful.client.swap.byidx(1) awful.client.focus.byidx(1) end,              {description = "select previous", group = "layout"}),
