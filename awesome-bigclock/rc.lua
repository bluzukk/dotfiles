...
EMPTY_SCREEN_PANEL = require("modules.panel.panel-empty")
LEFT_PANEL         = require("modules.panel.panel-left")
CENTER_PANEL       = require("modules.panel.panel-center")
RIGHT_PANEL        = require("modules.panel.panel-right")
-------------------------------------------------------------------------------
