...
root.buttons(gears.table.join(
  awful.button({}, 3, function() left_popup.toggle() end),
...
-- User programs
  ...
  -- awful.key({ modkey, }, "s", function() awesome.emit_signal("screen::lock") end,
  --   { description = "decrease master width factor", group = "layout" }),
  awful.key({ modkey, }, "p", function() checktag() end,
    { description = "decrease master width factor", group = "layout" }),
  awful.key({ modkey, "Shift" }, "space", function() awful.spawn(terminal) end,
    { description = "change wallpaper and theme", group = "hotkeys" }),
  awful.key({ modkey }, "u", function() WALLPAPER_SELECTOR.show() end,
