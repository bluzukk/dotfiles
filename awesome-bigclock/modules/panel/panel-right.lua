...
local panel = awful.popup {
  ...
  placement = function(c)
    awful.placement.top_right(c,
      { margins = { right = dpi(20), top = dpi(3) } })
  end,
...
tag.connect_signal("property::selected", function() check_visibility() end)
tag.connect_signal("tagged", function() check_visibility() end)
tag.connect_signal("untagged", function() check_visibility() end)
tag.connect_signal("list", function() check_visibility() end)

awesome.connect_signal("zenmode", function(evil)
  zenmode = evil
  if evil == true then
    panel.visible = false
  else
